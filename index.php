    ...
    <?php 
        ...
        $db = new DataBase();
        $admin = new Admin($db->connectDb());

        if(!empty($_POST)) {
            if(isset($_POST['btn']) && $_POST['btn'] == "send") {
                $admin->sendContactData($_POST['name'], $_POST['email'], $_POST['message']);
            }

            if(isset($_POST['btn-2']) && $_POST['btn-2'] == "btn-register")
            {
                $admin->register($_POST['name'],$_POST['email'],$_POST['phone_number']);
            }
        }
        ...
        <div class="row">
            ...
            <div class="right-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                    <fieldset>
                        <button type="submit" id="form-submit" class="button" name="btn-2" value="btn-register">Get it now</button>
                    </fieldset>
                    </div>
                </div>
                </form>
    ...
    <section class="section contact" data-section="section6">
        ...
        <div class="row">
            ...
            <form id="contact" action="" method="post">
                ...
                <div class="col-md-12">
                    <fieldset>
                    <button type="submit" name = "btn" value="send" id="form-submit" class="button">Send Message Now</button>
                    </fieldset>
                </div>
                </div>
            </form>
